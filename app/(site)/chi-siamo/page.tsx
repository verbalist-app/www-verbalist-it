    ...
    <section className="pt-20 md:pt-28 pb-24">
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="space-y-12">
          <section>
            <h3 className="font-serif text-xl font-medium tracking-tight mb-4">La storia</h3>
          ...
          <section>
            <h3 className="font-serif text-xl font-medium tracking-tight mb-4">I numeri</h3>
