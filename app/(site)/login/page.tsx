...
export default function LoginPage() {
  ...
  const handleEmailSubmit = (e: React.FormEvent) => {
    ...
    if (email.toLowerCase() === "admin@admin.it") {
      ...
      setError("Account non trovato. Usa admin@admin.it per la demo.")
    }
  }
  ...
  const handlePasswordSubmit = async (e: React.FormEvent) => {
    ...
    if (password === "admin") {
      ...
      setError("Password errata. Usa 'admin' per la demo.")
      setIsLoading(false)
    }
  }
            ...
            {step === "email" ? (
              <>
                <div className="space-y-2 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Inserisci l'email del tuo account per accedere
                  </p>
                </div>
              ...
              <>
                <div className="space-y-2 text-center">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Inserisci la password per <span className="font-medium text-foreground">{email}</span>
                  </p>
                </div>
