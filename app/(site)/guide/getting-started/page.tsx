    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: "Come iniziare", url: "/guide/getting-started" },
        ]}
      />
      <article className="pt-20 md:pt-28 pb-24">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="prose-verbalist max-w-none">
            ...
            <h2 className="text-sm font-medium text-foreground mb-2">2. Inserisci la keyword</h2>
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
            ...
            <h2 className="text-sm font-medium text-foreground mb-2">3. Analizza la SERP</h2>
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
            ...
            <h2 className="text-sm font-medium text-foreground mb-2">4. Rivedi i pattern</h2>
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
            ...
            <h2 className="text-sm font-medium text-foreground mb-2">5. Genera il contenuto</h2>
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
            ...
            <h2 className="text-sm font-medium text-foreground mb-2">6. Esporta e pubblica</h2>
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
