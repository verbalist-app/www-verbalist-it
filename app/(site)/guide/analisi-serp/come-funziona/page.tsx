    ...
    <article className="pt-20 md:pt-28 pb-24">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="prose prose-neutral max-w-none">
            <h2 className="text-sm font-medium text-foreground mb-2">1. Inserisci la keyword</h2>
            ...
            <h2 className="text-sm font-medium text-foreground mb-2">2. Selezione parametri</h2>
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
            ...
            <h2 className="text-sm font-medium text-foreground mb-2">3. Query a Google</h2>
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
            ...
            <h2 className="text-sm font-medium text-foreground mb-2">4. Estrazione dati base</h2>
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
              Per ogni risultato viene estratto: posizione, URL, title tag, meta description. Questi dati appaiono nella tabella risultati.
            </p>

            <h2 className="text-sm font-medium text-foreground mb-2">5. Scraping contenuto</h2>
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
            ...
            <h2 className="text-sm font-medium text-foreground mb-2">6. Analisi pattern</h2>
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
            ...
            <h2 className="text-sm font-medium text-foreground mb-2">Tempo di elaborazione</h2>
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
