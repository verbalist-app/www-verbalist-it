    ...
    <article className="pt-20 md:pt-28 pb-24">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="prose prose-neutral max-w-none">
            <h2 className="text-sm font-medium text-foreground mb-2">H1: il titolo principale</h2>
            ...
            <h2 className="text-sm font-medium text-foreground mb-2">H2: le sezioni principali</h2>
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
            ...
            <h2 className="text-sm font-medium text-foreground mb-2">H3-H6: la gerarchia</h2>
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
            ...
            <h2 className="text-sm font-medium text-foreground mb-2">Numero heading</h2>
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
            ...
            <h2 className="text-sm font-medium text-foreground mb-2">Ordine delle sezioni</h2>
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
            ...
            <h2 className="text-sm font-medium text-foreground mb-2">Heading semantici</h2>
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
