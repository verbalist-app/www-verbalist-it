    ...
    <article className="pt-20 md:pt-28 pb-24">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="prose-verbalist max-w-none">
            <h2 className="text-sm font-medium text-foreground mb-2">Perché Markdown</h2>
            ...
            <h2 className="text-sm font-medium text-foreground mb-2">Heading</h2>
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
              I tag H1-H6 diventano heading Markdown (# - ######). La gerarchia viene preservata esattamente come nell'originale.
            </p>

            <h2 className="text-sm font-medium text-foreground mb-2">Paragrafi e testo</h2>
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
            ...
            <h2 className="text-sm font-medium text-foreground mb-2">Liste</h2>
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
            ...
            <h2 className="text-sm font-medium text-foreground mb-2">Link</h2>
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
            ...
            <h2 className="text-sm font-medium text-foreground mb-2">Tabelle</h2>
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
              Le tabelle HTML diventano tabelle Markdown. Strutture complesse vengono semplificate mantenendo i dati essenziali.
            </p>

            <h2 className="text-sm font-medium text-foreground mb-2">Immagini</h2>
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
