    ...
    <article className="pt-20 md:pt-28 pb-24">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="prose-verbalist max-w-none">
            ...
            <h2 className="text-sm font-medium text-foreground mb-2">Esportazione batch</h2>
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
            ...
            <h2 className="text-sm font-medium text-foreground mb-2">Formato del file</h2>
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
            ...
            <h2 className="text-sm font-medium text-foreground mb-2">Altri formati</h2>
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
              Oltre a Markdown, puoi esportare in: plain text (senza formattazione), JSON (dati strutturati) e HTML (formattazione preservata).
            </p>

            <h2 className="text-sm font-medium text-foreground mb-2">Uso consigliato</h2>
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
