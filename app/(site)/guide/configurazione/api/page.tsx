    ...
    <article className="pt-20 md:pt-28 pb-24">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="prose-verbalist max-w-none">
            ...
            <h2 className="text-sm font-medium text-foreground mb-2">Generare API key</h2>
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
            ...
            <h2 className="text-sm font-medium text-foreground mb-2">Rate limits</h2>
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
            ...
            <h2 className="text-sm font-medium text-foreground mb-2">Webhook</h2>
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
            ...
            <h2 className="text-sm font-medium text-foreground mb-2">Integrazioni native</h2>
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
            ...
            <h2 className="text-sm font-medium text-foreground mb-2">Uso API</h2>
            <p className="text-sm text-muted-foreground leading-relaxed mb-4">
