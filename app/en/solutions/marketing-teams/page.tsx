  ...
  return (
    <>
      ...
      <HighlightBlock
        ...
        description="Configure your brand's style once. Every draft follows your guidelines. Professional, friendly, technical: you define the style, Verbalist helps you get started."
