    ...
    <article className="pt-20 md:pt-28 pb-24">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="prose prose-neutral max-w-none">
            <h2 className="font-serif text-xl font-medium mt-8 mb-4">Position and visibility</h2>
            ...
            <h2 className="font-serif text-xl font-medium mt-8 mb-4">Title and meta description</h2>
            <p className="text-muted-foreground mb-4">
            ...
            <h2 className="font-serif text-xl font-medium mt-8 mb-4">Content type</h2>
            <p className="text-muted-foreground mb-4">
            ...
            <h2 className="font-serif text-xl font-medium mt-8 mb-4">Search intent</h2>
            <p className="text-muted-foreground mb-4">
            ...
            <h2 className="font-serif text-xl font-medium mt-8 mb-4">Domain authority</h2>
            <p className="text-muted-foreground mb-4">
            ...
            <h2 className="font-serif text-xl font-medium mt-8 mb-4">SERP features</h2>
            <p className="text-muted-foreground mb-4">
