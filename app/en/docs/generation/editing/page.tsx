    ...
    <article className="pt-20 md:pt-28 pb-24">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="prose prose-neutral max-w-none">
            <h2 className="font-serif text-xl font-medium mt-8 mb-4">Integrated editor</h2>
            ...
            <h2 className="font-serif text-xl font-medium mt-8 mb-4">Add personal experience</h2>
            <p className="text-muted-foreground mb-4">
            ...
            <h2 className="font-serif text-xl font-medium mt-8 mb-4">Insert sources</h2>
            <p className="text-muted-foreground mb-4">
            ...
            <h2 className="font-serif text-xl font-medium mt-8 mb-4">Adapt the tone</h2>
            <p className="text-muted-foreground mb-4">
            ...
            <h2 className="font-serif text-xl font-medium mt-8 mb-4">Fact check</h2>
            <p className="text-muted-foreground mb-4">
              AI models can generate inaccurate information. Verify data, statistics, names, dates. Correct any errors before publishing.
            </p>

            <h2 className="font-serif text-xl font-medium mt-8 mb-4">SEO review</h2>
            <p className="text-muted-foreground mb-4">
