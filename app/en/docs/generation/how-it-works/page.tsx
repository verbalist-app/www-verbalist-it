    ...
    <article className="pt-20 md:pt-28 pb-24">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="prose prose-neutral max-w-none">
            <h2 className="font-serif text-xl font-medium mt-8 mb-4">Input: the patterns</h2>
            ...
            <h2 className="font-serif text-xl font-medium mt-8 mb-4">Prompt construction</h2>
            <p className="text-muted-foreground mb-4">
            ...
            <h2 className="font-serif text-xl font-medium mt-8 mb-4">Structured generation</h2>
            <p className="text-muted-foreground mb-4">
            ...
            <h2 className="font-serif text-xl font-medium mt-8 mb-4">SEO optimization</h2>
            <p className="text-muted-foreground mb-4">
            ...
            <h2 className="font-serif text-xl font-medium mt-8 mb-4">Final output</h2>
            <p className="text-muted-foreground mb-4">
