    ...
    <article className="pt-20 md:pt-28 pb-24">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="prose prose-neutral max-w-none">
            <h2 className="font-serif text-xl font-medium mt-8 mb-4">1. Choose specific keywords</h2>
            ...
            <h2 className="font-serif text-xl font-medium mt-8 mb-4">2. Analyze first, generate later</h2>
            <p className="text-muted-foreground mb-4">
            ...
            <h2 className="font-serif text-xl font-medium mt-8 mb-4">3. Always customize tone of voice</h2>
            <p className="text-muted-foreground mb-4">
            ...
            <h2 className="font-serif text-xl font-medium mt-8 mb-4">4. Add your experience</h2>
            <p className="text-muted-foreground mb-4">
            ...
            <h2 className="font-serif text-xl font-medium mt-8 mb-4">5. Cite authoritative sources</h2>
            <p className="text-muted-foreground mb-4">
            ...
            <h2 className="font-serif text-xl font-medium mt-8 mb-4">6. Keep content updated</h2>
            <p className="text-muted-foreground mb-4">
            ...
            <h2 className="font-serif text-xl font-medium mt-8 mb-4">7. Test and iterate</h2>
            <p className="text-muted-foreground mb-4">
            ...
            <h2 className="font-serif text-xl font-medium mt-8 mb-4">8. Structure for AI</h2>
            <p className="text-muted-foreground mb-4">
