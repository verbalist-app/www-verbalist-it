    ...
    <article className="pt-20 md:pt-28 pb-24">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="prose prose-neutral max-w-none">
            <h2 className="font-serif text-xl font-medium mt-8 mb-4">Why word count matters</h2>
            ...
            <h2 className="font-serif text-xl font-medium mt-8 mb-4">Reading the data</h2>
            <p className="text-muted-foreground mb-4">
            ...
            <h2 className="font-serif text-xl font-medium mt-8 mb-4">Interpreting patterns</h2>
            <p className="text-muted-foreground mb-4">
            ...
            <h2 className="font-serif text-xl font-medium mt-8 mb-4">Applying the data</h2>
            <p className="text-muted-foreground mb-4">
            ...
            <h2 className="font-serif text-xl font-medium mt-8 mb-4">Quality vs quantity</h2>
            <p className="text-muted-foreground mb-4">
