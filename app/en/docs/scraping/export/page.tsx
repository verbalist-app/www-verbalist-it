    ...
    <article className="pt-20 md:pt-28 pb-24">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="prose prose-neutral max-w-none">
            <h2 className="font-serif text-xl font-medium mt-8 mb-4">Single export</h2>
            ...
            <h2 className="font-serif text-xl font-medium mt-8 mb-4">Batch export</h2>
            <p className="text-muted-foreground mb-4">
            ...
            <h2 className="font-serif text-xl font-medium mt-8 mb-4">File format</h2>
            <p className="text-muted-foreground mb-4">
            ...
            <h2 className="font-serif text-xl font-medium mt-8 mb-4">Other formats</h2>
            <p className="text-muted-foreground mb-4">
              Besides Markdown, you can export to: plain text (no formatting), JSON (structured data) and HTML (formatting preserved).
            </p>

            <h2 className="font-serif text-xl font-medium mt-8 mb-4">Recommended use</h2>
            <p className="text-muted-foreground mb-4">
