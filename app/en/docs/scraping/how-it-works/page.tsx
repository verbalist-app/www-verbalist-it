    ...
    <article className="pt-20 md:pt-28 pb-24">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="prose prose-neutral max-w-none">
            <h2 className="font-serif text-xl font-medium mt-8 mb-4">Automatic visiting</h2>
            ...
            <h2 className="font-serif text-xl font-medium mt-8 mb-4">HTML extraction</h2>
            <p className="text-muted-foreground mb-4">
              The complete HTML code of the page is extracted, including all elements: text, headings, lists, tables, images (alt text).
            </p>

            <h2 className="font-serif text-xl font-medium mt-8 mb-4">Content cleaning</h2>
            <p className="text-muted-foreground mb-4">
            ...
            <h2 className="font-serif text-xl font-medium mt-8 mb-4">Main content identification</h2>
            <p className="text-muted-foreground mb-4">
            ...
            <h2 className="font-serif text-xl font-medium mt-8 mb-4">Markdown conversion</h2>
            <p className="text-muted-foreground mb-4">
            ...
            <h2 className="font-serif text-xl font-medium mt-8 mb-4">Error handling</h2>
            <p className="text-muted-foreground mb-4">
