  ...
  it: {
    ...
    cards: [
      ...
      },
      {
        ...
        description: 'Scarica heading, paragrafi e struttura di ogni competitor. Tutto in Markdown pulito, pronto per l\'analisi.',
      },
      {
      ...
      },
      {
        ...
        description: 'Genera un articolo completo basato su quello che funziona nei risultati Google. Title, meta description, heading e testo pronti da pubblicare.',
      },
    ],
  },
  en: {
    ...
    cards: [
      ...
      },
      {
        ...
        description: 'Downloads headings, paragraphs and structure from each competitor. All in clean Markdown, ready for analysis.',
      },
      {
      ...
      },
      {
        ...
        description: 'Generates a complete article based on what ranks. Title, meta description, headings and text ready to publish.',
      },
    ],
  },
} as const
  ...
  return (
    <section className={cn('bg-background py-24 lg:py-32', className)}>
      <div className="mx-auto w-full max-w-5xl px-6">
        <div>
          <h2 className="text-balance text-3xl font-medium tracking-tight sm:text-4xl">{t.title}</h2>
