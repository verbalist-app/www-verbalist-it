...
const phases = [
  {
    ...
    label: "Input",
    steps: [
      { icon: Search, name: "Keyword", desc: "Your target keyword" },
    ],
  },
  {
    id: "analysis",
    label: "Analysis",
    steps: [
      { icon: Globe, name: "SERP", desc: "Google top 10" },
      { icon: FileText, name: "Scraping", desc: "Content extraction" },
    ],
  },
  {
    id: "processing",
    label: "Processing",
    steps: [
      { icon: BarChart3, name: "Pattern", desc: "Winning patterns" },
      { icon: Sparkles, name: "AI Gen", desc: "AI generation" },
    ],
  },
  {
    id: "output",
    label: "Output",
    steps: [
      { icon: FileOutput, name: "Content", desc: "SEO-ready" },
    ],
  },
]
