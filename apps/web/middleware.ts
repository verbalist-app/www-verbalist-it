...
export const config = {
  matcher: ["/guide/:path*", "/soluzioni/:path*", "/guide", "/soluzioni"],
};
...
<head>
  ...
  <title>Contenuto rimosso | Verbalist</title>
  <style>
...
<body>
  <main>
    <h1>Questo contenuto non esiste più</h1>
    <p>La pagina è stata rimossa con il nuovo sito Verbalist.</p>
    <p><a href="/">Vai alla home</a> · <a href="/help">Help center</a></p>
  </main>
</body>
</html>`,
    {
